 			...
 			<div class="col-md-6 col-md-offset-3">
 				<div class="box box-success">
 					...
 					<div class="box-body with-border"> 						
 						<?=form_open('user/lihat_kalori/update_kalori/' .$id,'class="form-horizontal"')?>
 							<!--hidden-->
 					...
 					<div class="box-footer with-border clearfix">
 							<div class="form-group">
						    	...
						    	<input type="hidden" name="submitted" value="1">
						      	...
						      	<a href="<?php echo base_url('user/lihat_kalori/read_kalori')?>" class="btn btn-md btn-danger btn-flat"><i class="glyphicon glyphicon-remove"></i> Cancel</a>
						    	</div>
						  	</div>	
						<?=form_close();?>
