...
<body class="skin-green hold-transition fixed sidebar-mini">
    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            <a href="<?php echo base_url('user/chart/read_chart')?>" class="logo"><i class="fa fa-heartbeat"></i><b> Kalorimu</b></a>
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-footer">
                                    <div class="pull-left">
                                        <a href="<?php echo base_url('user/profil') ?>" class="btn btn-default btn-flat"><i class="glyphicon glyphicon-user"></i> Profile</a>
                                    </div>
