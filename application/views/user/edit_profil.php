                    ...
                    <div class="box-body with-border">
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <?=form_open_multipart('user/edit_profil/update_profil/'.$id,'class="form-horizontal"')?>
                                        <!--hidden-->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <span>*maksimal size 500 kb</span>
                                            </div>
                                        </div>
                            </div>
                        </div>
                    ...
                    <div class="box-footer with-border clearfix">
                                        <div class="form-group">
                                            <div class="col-sm-offset-5 col-sm-10">
                                                ...
                                                <a href="<?php echo base_url('user/profil') ?>" class="btn btn-danger btn-flat"><i class="glyphicon glyphicon-remove"></i> Cancel</a>
                                            </div>
                                        </div>
                                    <?=form_close();?>
                                </div>
