            ...
            <div class="col-md-6">
                <div class="box box-danger">
                    ...
                    <div class="box-body with-border">
                        <?=form_open('user/edit_profil/update_password/' .$id,'class="form-horizontal"')?>
                        <!--hidden-->
                    ...
                    <div class="box-footer with-border clearfix">
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-10">
                              ...
                              <a href="<?php echo base_url('user/profil') ?>" class="btn btn-flat btn-danger"><i class="glyphicon glyphicon-remove"></i> Kembali</a>
                            </div>
                          </div>
                        <?=form_close();?>
                    </div>
