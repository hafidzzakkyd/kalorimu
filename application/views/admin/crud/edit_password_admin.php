            ...
            <div class="col-md-6">
                <div class="box box-danger">
                    <div class="box-header with-border" style="background-color : #DD4B39;">
                        <h4 class="box-title judul-sub"><i class="glyphicon glyphicon-lock"></i> Password</h4>
                    </div>
                    <div class="box-body with-border">
                        <?=form_open('admin/crud/update_password/'.$id,'class="form-horizontal"')?>
                        <!--hidden-->
                    ...
                    <div class="box-footer with-border clearfix">
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-10">
                              <button type="submit" class="btn btn-primary btn-flat"><i class="glyphicon glyphicon-ok"></i> Ganti Password</button>
                              <a href="<?php echo base_url('admin/crud/update/'.$id) ?>" class="btn btn-flat btn-danger"><i class="glyphicon glyphicon-remove"></i> Kembali</a>
                            </div>
                          </div>
                        <?=form_close();?>
                    </div>
