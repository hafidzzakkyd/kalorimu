...
<?php   
 ...
 <?php 
        ...
        if($this->input->post('submitted')){
            ...
            $nama          = $user_id->nama_user;
            $username      = $user_id->username;
            $jenkel        = $user_id->jenis_kelamin;
            $tempatlahir   = $user_id->tempat_lahir;
            $tgllahir      = $user_id->tgl_lahir;
            $email         = $user_id->email;
            $alamat        = $user_id->alamat;
            $foto          = $user_id->foto;
 ?> 	
 			...
 			<div class="col-md-8 col-md-offset-2">
 				<div class="box box-primary">
 					<div class="box-header with-border" style="background-color : #3C8DBC;">
 						<h4 class="box-title judul-sub"><i class="glyphicon glyphicon-user"></i> Edit User</h4>
                        <a href="<?php echo base_url('admin/crud/update_password/'.$id) ?>" class="btn btn-danger btn-flat pull-right"><i class="glyphicon glyphicon-lock"></i> Password</a>
 					</div>
 					<div class="box-body with-border">
 						<div class="container">
 							<div class="row">
 								<div class="col-md-2">
 									<img class="img-circle img-responsive" src="<?php echo base_url('upload/'.$foto)?>">
 								</div>
 								<div class="col-md-4">
                                    <?=form_open_multipart('admin/crud/update/' .$id,'class="form-horizontal"')?>
                                        <!--hidden-->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <br>
                                                <span>*Foto dalam bentuk JPG</span><br>
